...
print("-----------------------------------")
draw_grid(map, width=3, path=reconstruct_path(came_from=came_from, start=start, goal=goal))
print("-----------------------------------")
draw_grid(map, width=3, path=reconstruct_path(came_from=came_from, start=start, goal=goal), path2=reconstruct_path2(came_from2=came_from2, start2=start2, goal2=goal2))
print("-----------------------------------")
